...
export default async function (msg) {
	...
	// 	return [
	// 		{ image: { url: image }, jpegThumbnail, mimetype: "image/jpeg", caption },
	// 	];
	...
	// 		"https://bakadame.com/?s=" + encodeURIComponent(anime)
	// 	);
	...
	// 		return msg.reply(msg.room_chat, {
	// 			text: "*" + noResult + "*\n\n404 *NOT FOUND*",
	// 		});
	...
	// 	return { text, quoted: true, isExtended: true };
}
...
// 				const data = $(el).text();
// 				if (
// 					$(el).css()["text-align"]?.includes("left") &&
// 					!data.includes("Judul Jepang") &&
// 					!data.includes("link error")
// 				) {
// 					sinopsis += `\n${data}\n`;
// 				}
// 				return;
